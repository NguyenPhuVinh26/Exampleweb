				...
				<div>
					<div class="col-sm-6" >
						<div class="logo pull-left" > <div>
                            <a href="index.php" style="background-color:#;color:#FFF"><p>Music Online</p> </a>
						</div></div> 
					</div>
						<div class="mainmenu pull-left">
							<ul class="nav navbar-nav collapse navbar-collapse">
                                ...
                                <i class="fa fa-star"></i>Regisger</a></li>
                                <?php
                                        }
                                        ?>
                                </li> 
